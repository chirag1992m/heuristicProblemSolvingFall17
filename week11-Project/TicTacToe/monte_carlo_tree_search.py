...
class MCTSTicTacToe:
    ...
    def build_mct(self):
        ...
        possible_actions = TicTacToeEnv.get_possible_actions(self.current_state)
        for action in possible_actions:
            new_state = current_state.copy()
            TicTacToeEnv.make_move(new_state, action, self.current_player)
    ...
    def move_to_child_with_action(self, action_taken):
        ...
        TicTacToeEnv.make_move(self.current_state, action_taken, self.current_player)
    ...
    def rollout(self, with_action):
        ...
        TicTacToeEnv.make_move(current_state, with_action, self.current_player)
        while True:
            winner = TicTacToeEnv.check_winner(current_state)
            chance = 1 - chance
            if winner > 0:
                if winner == 3:
                    return 0.
