"""
Code to train the Tic-Tac-Toe Self-Play agent as given in
...
from .model import AlphaZeroTicTacToe, loss_function
from .agents import SelfPlayRLAgent, RandomPlayer
from .monte_carlo_tree_search import MCTSTicTacToe
...
current_model = AlphaZeroTicTacToe()
best_model = AlphaZeroTicTacToe()
...
def generate_training_data(agent, data_path, n_games=training_games):
    ...
    for game in range(n_games):
        ...
        chance = 1
        reward = [0., 0.]
        mcts = MCTSTicTacToe(obs[chance], chance, agent, simulations=mcts_simulations,
